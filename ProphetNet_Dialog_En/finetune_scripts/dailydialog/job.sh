...
#REMOTE_IP_ADDR=$(ifconfig eth0 | grep 'inet' | awk '{print $2}')
#LOCAL_IP_ADDR='10.170.69.69'
#if [ "${REMOTE_IP_ADDR}" = ${LOCAL_IP_ADDR} ]
#then BASE_DIR=/home/v-wchen2/Data/dialogue/finetune/dailydialog
#else BASE_DIR=/mnt/dialogue/finetune/dailydialog
#fi

SUFFIX='_reddit_pretrain_ck_best'
BASE_DIR=/mnt/dialogue/finetune/dailydialog
